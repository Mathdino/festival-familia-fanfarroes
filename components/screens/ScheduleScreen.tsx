      ...
      <div className="bg-[#121315] border border-[#0080cc]/20 rounded-2xl p-4 mb-6">
        ...
        <div className="space-y-2">
          {[
            ...
            {
              label: "Troca de equipes",
              value: "10 minutos",
              color: "#ffffff44",
            },
            {
              label: "Em caso de empate",
              value: "Pênaltis (5 cada)",
              color: "#f59e0b",
            },
          ].map((item) => (
      ...
      {loading ? (
        <div className="space-y-3">
          {[1, 2, 3].map((i) => (
            <div
              key={i}
              className="h-20 bg-[#121315] rounded-2xl animate-pulse"
            />
          ))}
        </div>
      ) : schedules.length === 0 ? (
        <div className="flex flex-col items-center justify-center py-16 text-center">
          ...
          <p className="text-white/20 text-xs mt-1">
            O admin irá cadastrar em breve!
          </p>
        </div>
      ) : (
        <div className="space-y-3">
  ...
  return (
    ...
    >
      ...
      <div className="flex justify-between items-center mb-3">
        <span
          className="text-[#0080cc] text-xs font-bold uppercase tracking-wider"
          style={{ fontFamily: "Barlow Condensed, sans-serif" }}
        >
          {game.round}
        </span>
        ...
        <div className="flex flex-col items-center px-2">
          {hasResult ? (
            <div className="bg-[#0080cc]/20 border border-[#0080cc]/40 rounded-lg px-2 py-0.5">
              <span
                className="text-[#0080cc] text-sm font-black"
                style={{ fontFamily: "Barlow Condensed, sans-serif" }}
              >
                {game.result}
              </span>
